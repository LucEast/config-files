...
link_directory_contents() {
  ...
  # Aktiviere dotglob, um sicherzustellen, dass * auch versteckte Dateien einschließt
  shopt -s dotglob
  ...
  # Deaktiviere dotglob nach Gebrauch, um das Standardverhalten wiederherzustellen
  shopt -u dotglob
}
...
delete_links() {
    ...
    shopt -u dotglob # Revert to default behavior (exclude hidden files)
}
